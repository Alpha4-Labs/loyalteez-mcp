...
import {
  listEventTypeResources,
  readEventTypeResource,
  isEventTypeResource,
} from '../src/resources/event-types.js';
import {
  listSharedServicesResources,
  readSharedServicesResource,
  isSharedServicesResource,
} from '../src/resources/shared-services.js';
import {
  listOAuthResources,
  readOAuthResource,
  isOAuthResource,
} from '../src/resources/oauth.js';
